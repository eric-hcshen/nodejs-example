...
console.info();
/**
 * 使用setTimeout()方法執行異步操作
 */
console.time('startB'); // TODO: console.time()計時器B
...
console.timeEnd('startB');  // TODO: console.time()計時器B
/**
 * 使用process.nextTick()方法執行異步操作
 */
console.time('startA'); // TODO: console.time()計時器A
...
console.timeEnd('startA');  // TODO: console.time()計時器A
console.info();
console.info("------   Process nextTick   ------");